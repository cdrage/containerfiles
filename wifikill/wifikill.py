...
# Let's ignore this since we're running it in a container :)
'''
if os.geteuid() != 0:
...
while refreshing:
  ...
  print "Note: Remember to Ctrl+C to exit / restore internet to victims"
